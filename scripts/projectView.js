...
projectView.populateChecklist = function() {
  $('.populated').each(function() {
     ...
     val.forEach(function(tag) {
       optionTag = '<div class="col-sm-4"><li><label for="chk1"><input type="checkbox" name="chk1" value="'+tag+'" id="'+tag.split(' ')[0]+'"><img src="/media/tree3_c.png"> '+tag+' <img src="/media/tree3_c.png"></label></li></div>';
